    ...
    <div class="card-body">
        ...
        @csrf
            ...
            <div class="mb-3 d-flex">
                ...
                <div class="mb-3">
                    <label for="" class="form-lable mb-2">Check visible apartment</label>
                    <div class="form-check">
                        <input type="radio" class="form-check-input" id="radio1" name="optradio" value="visible"
                            checked>Visible
                        <label class="form-check-label" for="radio1"></label>
                    </div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input" id="radio2" name="optradio"
                            value="not_visible">Not visible
                        <label class="form-check-label" for="radio2"></label>
                    </div>
                </div>

                {{-- Button to save your apartment --}}
                <button class="btn mt-3 btn_hover text-white" type="submit"
                    style="background-color: #FF385C;"><strong>Save your apartament</strong>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-save ms-2" viewBox="0 0 16 16">
                        <path
