    ...
    <div class="container mt-3">
        <div class="row g-4">
            <div class="col">
                ...
                <hr>
                <img src="{{ str_contains($apartment->cover_image, 'http') ? $apartment->cover_image : asset('storage/' . $apartment->cover_image) }}"
                ...
                <div class="maps w-50 mx-auto my-5 text-center">
                    <h6>{{ $apartment->latitude }}</h6>
                    <h6>{{ $apartment->longitude }}</h6>
                </div>

                <div class="card-body w-75 mx-auto  my-5">
                    <div class="d-flex justify-content-between ms-5">

                        <div class="card-body d-flex flex-column justify-content-between pb-0 ms-5">

                            <h6 class="d-flex align-items-center ms-5">
                                <img class="me-3"
                    ...
                    <div class="d-flex justify-content-between ms-5">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between pb-0 pt-0 ms-5">
